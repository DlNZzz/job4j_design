...
insert into product(name, type_id, expired_date, price) values ('a', 15, date '2020.10.10', 120);
...
insert into product(name, type_id, expired_date, price) values ('молоко3', 21, date '2021.10.10', 40);
insert into product(name, type_id, expired_date, price) values ('молоко2', 21, date '2021.10.10', 50);
insert into product(name, type_id, expired_date, price) values ('молоко4', 21, date '2021.10.10', 50);
insert into product(name, type_id, expired_date, price) values ('молоко5', 21, date '2022.10.10', 50);
...
select type.name, count(p.id) from product as p RIGHT JOIN type
